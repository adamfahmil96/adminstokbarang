...
class M_barang_hrv extends CI_Model
{
	...
	$this->db->or_like('waktu_tambah', $q);
	$this->db->or_like('waktu_update', $q);
	$this->db->or_like('flag_barang', $q);
...
/* End of file M_barang_hrv.php */
/* Location: ./application/models/M_barang_hrv.php */
