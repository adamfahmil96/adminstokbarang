...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $c_jenis_hrv->flag_jenis ?></td>
			<td style="text-align:center" width="200px">
				<?php
				echo anchor(site_url('c_jenis_hrv/read/'.$c_jenis_hrv->id),'Read');
				echo ' | ';
				echo anchor(site_url('c_jenis_hrv/update/'.$c_jenis_hrv->id),'Update');
				echo ' | ';
				echo anchor(site_url('c_jenis_hrv/delete/'.$c_jenis_hrv->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
				?>
			</td>
		</tr>
                <?php
